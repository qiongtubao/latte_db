...
var MySqlConnectProxy = (function (_super) {
    __extends(MySqlConnectProxy, _super);
    function MySqlConnectProxy(connect) {
    ...
    return MySqlConnectProxy;
}(connect_1.default));
exports.default = MySqlConnectProxy;
