...
var PostGreSqlConnectProxy = (function (_super) {
    __extends(PostGreSqlConnectProxy, _super);
    function PostGreSqlConnectProxy(connect) {
    ...
    PostGreSqlConnectProxy.prototype.queryResultArray = function (data) {
        return data.rows;
    };
    return PostGreSqlConnectProxy;
}(connect_1.default));
exports.default = PostGreSqlConnectProxy;
