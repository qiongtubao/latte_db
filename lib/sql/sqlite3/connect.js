...
var Sqlite3ConnectProxy = (function (_super) {
    __extends(Sqlite3ConnectProxy, _super);
    function Sqlite3ConnectProxy(connect) {
    ...
    return Sqlite3ConnectProxy;
}(connect_1.default));
exports.default = Sqlite3ConnectProxy;
