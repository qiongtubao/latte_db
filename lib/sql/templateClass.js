...
exports.default = (function (tableName, config) {
    ...
    var templateClass = (function () {
        function templateClass(data) {
            ...
            this.flush = function () {
                _this.oldData = latte_lib.utils.copy(_this.data.toJSON());
                _this.updateData = latte_lib['object'].create({});
                return _this;
            };
            this.clean = function () {
                _this.data = latte_lib['object'].create(latte_lib.utils.copy(_this.oldData));
                _this.updateData = latte_lib['object'].create({});
                return _this;
            };
        ...
        templateClass.query = function (wheres, options) {
        ...
        templateClass.queryPromise = function (wheres, options) {
            return function (connect) {
                var func = templateClass.query(wheres, options);
        ...
        templateClass.del = function (wheres) {
            if (isTemplateClass(wheres)) {
                wheres = getWhere(wheres);
            }
            return function (connect, callback) {
        ...
        templateClass.delPromise = function (wheres) {
            return function (connect) {
                var func = templateClass.del(wheres);
                return latte_lib['promise'].promisify(func)(connect);
            };
        };
        ...
        templateClass.addPromise = function (g) {
            return function (connect) {
                var func = templateClass.add(g);
                return latte_lib['promise'].promisify(func)(connect);
            };
        };
        ...
        templateClass.createTable = function (options) {
            return function (connect, callback) {
                connect.createTable(tableName, config, options, callback);
            };
        };
        templateClass.update = function (wheres, update) {
            var g;
            if (isTemplateClass(wheres)) {
                g = wheres;
        ...
        templateClass.updatePromise = function (wheres, update) {
            return function (connect) {
                var func = templateClass.update(wheres, update);
                return latte_lib['promise'].promisify(func)(connect);
            };
        };
